...
import cn.oddcloud.www.oc_reload.Utils.IT_RebackCallData;
import cn.oddcloud.www.oc_reload.View.Adapter.NewsAnd_IT_Adapter;

/**
 * Created by florentchampigny on 24/04/15.
 */
public class IT_InformationFragment extends Fragment {
   ...
   private Handler handler;
    ...
    public static IT_InformationFragment newInstance() {
        return new IT_InformationFragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        new Thread(){
            ...
            public void run() {
                super.run();
                IT_RebackCallData.GetReCallcontent(handler);
            }
        }.start();
