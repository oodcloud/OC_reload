...
import cn.oddcloud.www.oc_reload.Utils.Tech_RebackCallData;
import cn.oddcloud.www.oc_reload.View.Adapter.NewsAnd_IT_Adapter;


public class SiteArticles_fragment extends Fragment {
    ...
    Handler handler;
    public static SiteArticles_fragment newInstance() {
        return new SiteArticles_fragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        layout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Tech_RebackCallData.GetReCallcontent(handler);
            }
        });
        //加载图片缓存
        new Thread(){
