...
import cn.oddcloud.www.oc_reload.Utils.News_RebackCallData;
import cn.oddcloud.www.oc_reload.View.Adapter.NewsAnd_IT_Adapter;


public class RecommendArticlesFragment extends Fragment {
   ...
   private PullRefreshLayout layout;
    ...
    public static RecommendArticlesFragment newInstance() {
        return new RecommendArticlesFragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        layout.setOnRefreshListener(new PullRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                News_RebackCallData.GetReCallcontent(handler);
            }
        });
        //加载图片缓存
        new Thread(){
